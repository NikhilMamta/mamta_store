    ...
    const hasPermission = useMemo(() => {
        return (routeItem: RouteAttributes) => {
            const pathToPermissionMap: Record<string, keyof UserPermissions> = {
                ...
                'create-indent': 'create_indent',
                'all-indent': 'all_indent',
                'create-po': 'create_po',
                'approve-indent': 'approve_indent',
                'po-history': 'po_history',
                'po-approval': 'po_approval',
                'pending-pos': 'pending_pos',
                'receive-items': 'receive_items',
                'store-out-approval': 'store_out_approval',
                'store-out': 'store_out',
                'quotation': 'quotation',
                'three-party-approval': 'three_party_approval',
                'vendor-rate-update': 'vendor_rate_update',
